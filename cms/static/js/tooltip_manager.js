define(['jquery', 'underscore'], function($, _) {
    ...
    var TooltipManager = function (element) {
        ...
        if (!this.tooltip.length) {
            ...
            }).css('opacity', 0).appendTo(this.element);
        }
    ...
    TooltipManager.prototype = {
        ...
        showTooltip: function(event) {
            ...
            this.tooltipTimer = setTimeout(this.show, 200);
        },
        ...
        hideTooltip: function() {
            clearTimeout(this.tooltipTimer);
            // Wait for a 200ms before hide the tooltip to avoid blinking when
            // the item contains nested elements.
            this.tooltipTimer = setTimeout(this.hide, 200);
        },

        destroy: function () {
            this.tooltip.remove();
            // Unbind all delegated event handlers n the ".TooltipManager"
            // namespace.
